...
- **copertura**, per cui $B \cup C = A$:
	...
	digraph {
		...
		1 -> A [dir=forward arrowhead=onormal color="black:black"]
...
digraph {
...

	{
		...
		Giocatori [
			...
			label=<<table border="0" cellborder="1" cellspacing="0" cellpadding="5">
				...
				<tr><td>- Nome: string<br align="left"/>- Cognome: string<br align="left"/>- AnnoNascita: int<br align="left"/></td></tr>
			</table>>
		]
		...
		Tornei [
			...
			label=<<table border="0" cellborder="1" cellspacing="0" cellpadding="5">
				<tr><td>Tornei</td></tr>
				<tr><td>- DataInizio: date<br align="left"/>- DataFine: date<br align="left"/></td></tr>
			</table>>
		]
	}
...

	{
		...
		Ospiti [
			...
			label=<<table border="0" cellborder="1" cellspacing="0" cellpadding="5">
				<tr><td>Ospiti</td></tr>
				<tr><td>- Nazionalità: string</td></tr>
			</table>>
		]
		...
		Soci [
			...
			label=<<table border="0" cellborder="1" cellspacing="0" cellpadding="5">
				<tr><td>Soci</td></tr>
				<tr><td>- Telefono: string<br align="left"/>- Indirizzo: string<br align="left"/></td></tr>
			</table>>
		]
	}
...
digraph {
...

	{
		...
		Hangar [
			...
			label=<<table border="0" cellborder="1" cellspacing="0" cellpadding="5">
				<tr><td>Hangar</td></tr>
				<tr><td>- Numero: int<br align="left"/>- Capienza: int<br align="left"/>- Ubicazione: string<br align="left"/></td></tr>
			</table>>
		]
		...
		Tipi [
			...
			label=<<table border="0" cellborder="1" cellspacing="0" cellpadding="5">
				<tr><td>Tipi</td></tr>
				<tr><td>- NumeroModello: int<br align="left"/>- Capacità: int<br align="left"/>- Peso: int<br align="left"/></td></tr>
			</table>>
		]
	}
...

	{
		...
		Manutenzioni [
			...
			label=<<table border="0" cellborder="1" cellspacing="0" cellpadding="5">
				...
				<tr><td>- Data: date<br align="left"/>- Lavoro: string<br align="left"/></td></tr>
			</table>>
		]
		...
		Meccanici [
			...
			label=<<table border="0" cellborder="1" cellspacing="0" cellpadding="5">
				...
				<tr><td>- Nome: string<br align="left"/>- Cognome: string<br align="left"/>- Stipendio: int<br align="left"/></td></tr>
			</table>>
		]
	}
...

	{
		...
		Persone [
			...
			label=<<table border="0" cellborder="1" cellspacing="0" cellpadding="5">
				<tr><td>Persone</td></tr>
				<tr><td>- Nome: string<br align="left"/>- Cognome: string<br align="left"/>- Telefoni: seq string<br align="left"/></td></tr>
			</table>>
		]
		...
		Aziende [
			...
			label=<<table border="0" cellborder="1" cellspacing="0" cellpadding="5">
				<tr><td>Aziende</td></tr>
				<tr><td>- RagioneSociale: string<br align="left"/>- Email: string<br align="left"/></td></tr>
			</table>>
		]
	}
...
digraph {
...

	{
		...
		Studenti [
			...
			label=<<table border="0" cellborder="1" cellspacing="0" cellpadding="5">
				...
				<tr><td>- CodFiscale: string &lt;PK&gt;<br align="left"/>- Telefoni: seq string<br align="left"/></td></tr>
			</table>>
		]
		...
		Livelli [
			...
			label=<<table border="0" cellborder="1" cellspacing="0" cellpadding="5">
				<tr><td>Livelli</td></tr>
				<tr><td>- Codice: string<br align="left"/>- Descrizione: string<br align="left"/></td></tr>
			</table>>
		]
	}

	{
		...
		Serate [
			...
			label=<<table border="0" cellborder="1" cellspacing="0" cellpadding="5">
				<tr><td>Serate</td></tr>
				<tr><td>- Consumazioni: int<br align="left"/></td></tr>
			</table>>
		]
		...
		Locali [
			...
			label=<<table border="0" cellborder="1" cellspacing="0" cellpadding="5">
				<tr><td>Locali</td></tr>
				<tr><td>- Nome: string<br align="left"/>- Indirizzo: string<br align="left"/></td></tr>
			</table>>
		]
	}

	{
		...
		Brani [
			...
			label=<<table border="0" cellborder="1" cellspacing="0" cellpadding="5">
				<tr><td>Brani</td></tr>
				<tr><td>- Titolo: string<br align="left"/>- Data: date<br align="left"/>- Autore: string<br align="left"/></td></tr>
			</table>>
		]
	}
